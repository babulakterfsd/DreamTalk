          ...
          <div className="mainbannertext mt-[44vh] sm:mt-36 lg:mt-20">
            ...
            >
              <form className="relative" onSubmit={handleSubmit}>
                <input
                  type="email"
                  className={`${Styles.heroinput} w-[86vw] sm:w-[60vw] lg:w-[600px] h-14 pl-5 lg:pl-10 text-sm border rounded-full bg-[rgba(24,33,46,1)] lg:bg-[#161a25] border-none focus:outline-none -ml-1 lg:-ml-3 font-crimson`}
